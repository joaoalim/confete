...
<head>
    ...
    <link rel="stylesheet" href="../Trabalho Confeitaria/pedido.css">
    <link rel="shortcut icon" href="../Trabalho Confeitaria/IMAGENS/bolo-icon.ico" type="image/x-icon">
...
<body>
    <div>
        ...
        <a href="../Trabalho Confeitaria/login.html">Finalizar pedido</a>
